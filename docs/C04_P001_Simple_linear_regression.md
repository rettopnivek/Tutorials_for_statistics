...
Given an independent variable/predictor \\(\text{\textbf{x}} = \{x_1, x_2, ..., x_n\}\\) and a dependent variable/outcome \\(\text{\textbf{y}} = \{y_1, y_2, ..., y_n\}\\), the formula for the simple linear regression model is
