...
Given an independent variable/predictor **x** = \\(\\{x_1, x_2, ..., x_n\\}\\) and a dependent variable/outcome **y** = \\(\\{y_1, y_2, ..., y_n\\}\\), the formula for the simple linear regression model is
